...
wget "http://127.0.0.1:8000/server/WCS/register/Local WCS/url/http://127.0.0.1:8081/gs215/ows" -O /dev/null
wget "http://127.0.0.1:8000/server/WFS/register/Local WFS/url/http://127.0.0.1:8081/gs215/ows" -O /dev/null
wget "http://127.0.0.1:8000/server/WPS/register/Local WPS/url/http://127.0.0.1:5000/wps" -O /dev/null
