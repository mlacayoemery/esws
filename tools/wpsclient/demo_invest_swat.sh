wget "http://127.0.0.1:8000/server/CSV/register/Local CSV/url/http://192.168.122.22:8001" -O /dev/null
...
wget "http://127.0.0.1:8000/server/WPS/register/Local WPS/url/http://192.168.122.22:5000/wps" -O /dev/null
